...
class ReproMainPage extends StatefulWidget {
  const ReproMainPage({super.key});

  @override
  State<ReproMainPage> createState() => _ReproMainPageState();
}

class _ReproMainPageState extends State<ReproMainPage> {
  @override

  void FemaleDogsOpen() {
      Navigator.of(context).push(
        MaterialPageRoute(builder: (context) => CreerFacturePage()),
      );
  }
  void CreateCatFiche() {
     Navigator.of(context).push(
        MaterialPageRoute(builder: (context) => ContratReservationPage()),
      );
  }
   ...
   return Scaffold(
        body: Center(
            child: Container(
                  ...
                  SizedBox(
                      height: UTILS.calculHeight(140, UTILS.heightReference(context))),
