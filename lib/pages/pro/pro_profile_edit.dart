...
class _ProProfileEditPageState extends State<ProProfileEditPage> {
  ...
  bool get _isBookingPro => _catProAvecRdv.contains(_catPro);
            ...
            SliverPadding(
              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  if (_isBookingPro) ...[
                    const SizedBox(height: 24),
                    _sectionTitle('Délai minimum de réservation'),
                    const SizedBox(height: 4),
                    Text('Empêche les réservations de dernière minute : un client ne pourra '
                        'pas prendre un créneau qui commence dans moins de ce délai.',
                        style: TextStyle(fontFamily: 'Galey', fontSize: 12, color: Colors.grey.shade500)),
                    const SizedBox(height: 10),
                    DropdownButtonFormField<int>(
                      initialValue: _delaiMinReservationH,
                      ...
                      items: const [
                        DropdownMenuItem(value: 0, child: Text('Aucun délai', style: TextStyle(fontFamily: 'Galey', fontSize: 14))),
                        DropdownMenuItem(value: 12, child: Text('12 h à l\'avance', style: TextStyle(fontFamily: 'Galey', fontSize: 14))),
                        DropdownMenuItem(value: 24, child: Text('24 h à l\'avance', style: TextStyle(fontFamily: 'Galey', fontSize: 14))),
                        DropdownMenuItem(value: 48, child: Text('48 h à l\'avance', style: TextStyle(fontFamily: 'Galey', fontSize: 14))),
