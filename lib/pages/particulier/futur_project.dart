...
class FuturProjectRegistrationPage extends StatefulWidget {
  const FuturProjectRegistrationPage({super.key});

  @override
  State<FuturProjectRegistrationPage> createState() =>
      _FuturProjectRegistrationPageState();
}

class _FuturProjectRegistrationPageState
    extends State<FuturProjectRegistrationPage>
              ...
              colorBlendMode: BlendMode.srcIn,
                      ...
                      Align(
                          ...
                          child: SizedBox(
                            ...
                            child: Text(
                              'Parlez nous de votre projets d’adoption',
                              style: TextStyle(
                                  fontSize: UTILS.calculWidth(
                          ...
                          child: SingleChildScrollView(
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                hintText: "Parlez nous de votre projets d’adoption",
                     ...
                     SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          User_Info.adoptProject = _futurProject.text;
