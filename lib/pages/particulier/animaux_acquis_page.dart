...
class _AnimauxAcquisPageState extends State<AnimauxAcquisPage> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      if (mounted) setState(() { _animaux = List<Map<String, dynamic>>.from(rows); _loading = false; });
    } catch (_) {
...
class _AnimalCard extends StatelessWidget {
  ...
  const _AnimalCard({
    ...
    required this.onCeder, required this.canCeder,
  });
        ...
        child: Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Container(
              ...
              child: Text('Lecture seule', style: TextStyle(fontSize: 10, color: Colors.grey.shade500)),
            ),
          ])),
