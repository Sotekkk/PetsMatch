...
class ParametreConfi extends StatefulWidget {
  const ParametreConfi({super.key});

  @override
  State<ParametreConfi> createState() => _ConditionGeneralState();
}

class _ConditionGeneralState extends State<ParametreConfi>
