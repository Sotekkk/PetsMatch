...
| A37 | Notification push mise-bas — rappel FCM J-7, J-3 et J-1 avant la date de terme estimée d'une gestation confirmée. Cloud Function similaire à `sendRdvReminders` qui parcourt les gestations confirmées avec `date_prevue` dans les 7 prochains jours. | Haute | Firebase Functions + App | `functions/agenda.js`, `functions/index.js` |
