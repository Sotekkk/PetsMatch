...
// Contrats de prestation maréchalerie — un contrat par RDV
// (type='contrat_prestation_marechal'), généré depuis l'agenda (RDV).
// Cette page ne fait que lister/rouvrir ce qui existe déjà — pas de
// création manuelle ici — même principe que côté appli
// (lib/pages/pro/marechal_contrats_page.dart).
...
export default function MarechalContratPage() {
  ...
  const load = useCallback(async () => {
    ...
    let q = supabase.from('documents_animaux')
      ...
      .eq('uid_eleveur', user.uid).eq('type', 'contrat_prestation_marechal');
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">Contrats de prestation maréchalerie générés depuis vos RDV</p>
      </div>
