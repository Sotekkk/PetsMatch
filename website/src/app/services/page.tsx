...
const SECTIONS: ServiceSection[] = [
  {
    ...
    colorLight: '#E8F5E9',
    items: [
      { id: 'vet',      label: 'Vétérinaires',          icon: '🩺', href: '/services/carte' },
      { id: 'urgence',  label: 'Urgences vétérinaires', icon: '🚨', href: '/services/carte' },
      { id: 'osteo',    label: 'Ostéopathes',           icon: '🖐️', href: '/services/carte' },
      { id: 'kine',     label: 'Kinésithérapeutes',     icon: '💪', href: '/services/carte' },
      { id: 'naturo',   label: 'Naturopathes',          icon: '🌿', href: '/services/carte' },
  ...
  },
  {
    ...
    colorLight: '#FFF3E0',
    items: [
      { id: 'educ',    label: 'Éducateurs / Comportementalistes', icon: '🎓', href: '/services/carte' },
      { id: 'petsit',  label: 'Pet sitter / Promeneurs',         icon: '🏠', href: '/services/carte' },
      { id: 'pension', label: 'Pension pour animaux',            icon: '🏡', href: '/services/carte' },
    ],
  },
  {
    id: 'sorties',
  ...
  },
  {
    ...
    colorLight: '#F3E5F5',
    items: [
      { id: 'boutiques', label: 'Boutiques & Accessoires', icon: '🏪', href: '/services/carte' },
      { id: 'petfood',   label: 'Petfood & Alimentation',  icon: '🥩', href: '/services/carte' },
      { id: 'createurs', label: 'Créateurs pour animaux',  icon: '🎨', href: '/services/carte' },
