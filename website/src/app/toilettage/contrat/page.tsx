...
// Contrats de prestation toilettage — un contrat par RDV
// (type='contrat_prestation_toilettage'), généré depuis l'agenda (RDV).
// Cette page ne fait que lister/rouvrir ce qui existe déjà — pas de
// création manuelle ici — même principe que côté appli
// (lib/pages/pro/toilettage_contrats_page.dart).
...
export default function ToilettageContratPage() {
  ...
  const load = useCallback(async () => {
    ...
    let q = supabase.from('documents_animaux')
      ...
      .eq('uid_eleveur', user.uid).eq('type', 'contrat_prestation_toilettage');
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">Contrats de prestation toilettage générés depuis vos RDV</p>
      </div>
